...
void displayUpdate() {
  ...
  */
  ...
  display.print(voice.patch.engine);
  display.print(" ");
  ...
  display.print("h: ");
  display.print(voice.patch.harmonics);  // user sees 1-8
  ...
  display.print("p:");
  display.print(voice.patch.note);

  display.setCursor(mode_text_pos.x, play_text_pos.y);
  display.print("t: ");
  display.print(voice.patch.timbre);
  // play/pause
